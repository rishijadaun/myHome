...
class AdminBrokerController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        Notification::create([
            ...
            'user_id' => $user->id,
            'user_type' => 'broker',
            'title' => 'Welcome to StayNest Broker Network 🎉',
            'message' => 'Your partner broker account has been created and verified by StayNest Administrator.',
            'type' => 'broker_welcome',
            'is_read' => 0,
    ...
    public function approve(Request $request, $id)
    {
        ...
        Notification::create([
            ...
            'message' => 'Congratulations! Your partner broker account & KYC documents have been approved by StayNest administration.',
            'type' => 'kyc_approved',
            'is_read' => 0,
            'action_url' => '/broker/dashboard',
        ]);
