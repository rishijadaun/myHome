...
@section('title', 'About Us - India\'s Trusted Zero Brokerage PG & Co-Living Discovery | SpaceSeeks')
@section('meta_description', 'Learn about SpaceSeeks\'s mission to eliminate brokerages and provide safe, 100% verified, and comfortable student & professional paying guest accommodations across 18+ cities in India.')
@section('meta_keywords', 'About SpaceSeeks, Co-living company India, Zero brokerage PG network, Verified hostel discovery')
...
<script type="application/ld+json">
{
  ...
  "@type": "AboutPage",
  "name": "About SpaceSeeks",
  "url": "{{ route('user.about') }}",
  "description": "SpaceSeeks is India's leading zero-brokerage PG and co-living discovery platform.",
  "mainEntity": {
    "@type": "Organization",
    "name": "SpaceSeeks Technologies Pvt. Ltd.",
    "url": "{{ route('user.home') }}",
    "foundingDate": "2023",
    "founders": [
      {
        "@type": "Person",
        "name": "SpaceSeeks Team"
      }
    ]
  }
}
...
<div class="pt-20 md:pt-10 pb-20 max-w-7xl mx-auto px-4 md:px-6 space-y-16">
    ...
    <div class="text-center max-w-3xl mx-auto space-y-4">
        ...
        <p class="text-gray-500 text-sm md:text-base leading-relaxed">SpaceSeeks was born out of a simple struggle: finding a safe, hygienic, and welcoming paying guest accommodation without paying extortionate brokerage fees. We are building India's most trusted co-living and PG discovery network.</p>
    </div>
    ...
    <div class="bg-white rounded-3xl p-6 md:p-12 border border-gray-100 shadow-sm">
        <div class="text-center max-w-2xl mx-auto mb-10 md:mb-12">
            <h2 class="text-2xl md:text-3xl font-bold text-gray-900">What Makes SpaceSeeks Different?</h2>
    ...
    <div class="bg-gradient-to-r from-brand to-brand-dark rounded-3xl p-8 md:p-12 text-white text-center space-y-6 shadow-xl shadow-brand/20">
        ...
        <p class="text-white/80 max-w-xl mx-auto text-xs md:text-sm">Join thousands of students and professionals who found their dream accommodation on SpaceSeeks.</p>
